        ...
        visitor: {
            ...
            'package.json': ({
                ...
                const pkg = {
                    ...
                    version: '0.0.1',
                    description:
                        'A new project based on @devgfnl/pwa-studio-typescript-template',
                    author,
                    license: 'UNLICENSED',
                    scripts: {}
                };
            ...
            'README.md': ({ path, targetPath }) => {
                const readme = fs.readFileSync(path, 'utf8');
                const content =`Documentation for Magento PWA Studio packages is located at [https://developer.adobe.com/commerce/pwa-studio/](https://developer.adobe.com/commerce/pwa-studio/).`
